...
>
> Download the second dataset from [here](https://github.com/ARCTraining/lal_r/blob/gh-pages/Anaphora.data.rda?raw=true)
>
> And the third dataset from [here](https://github.com/ARCTraining/lal_r/blob/2016.06/datPH_trimmed.rda?raw=true)
> 1. Download the file (CTRL + S, right mouse click -> "Save as", or File -> "Save page as")
> 2. Make sure they are saved under the names `gapminder-FiveYearData.csv`,  `datPH_trimmed.rda` and `Anaphora.data.rda`
